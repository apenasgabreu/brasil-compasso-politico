...
import { ArrowLeft, ArrowRight, BookOpen, Check, ChevronRight, Cpu, ExternalLink, FileText, Info, Loader2, LockKeyhole, Map, RotateCcw, Scale, ShieldCheck, Sparkles } from "lucide-react";
...
export default function Home() {
  ...
  const renderWeights = () => <div className="narrow-stage"><SectionTitle eyebrow="Antes de começar" title="O que importa mais para você?" text="Aumente o peso dos temas que você considera decisivos. Todos começam com peso padrão; isso só muda a importância que suas próprias respostas terão no cálculo." />
  ...
  const renderQuiz = () => <div className="quiz-shell">
    ...
    <p className="quiz-help">Escolha a alternativa que melhor representa sua posição. “Não sei / Prefiro não responder” será excluída do seu cálculo, sem ser transformada em resposta neutra.</p>
  ...
  const renderMethod = () => <div className="method-shell"><SectionTitle eyebrow="Transparência metodológica" title="O resultado é reproduzível, e seus limites são visíveis." text="A ferramenta mede concordância com afirmações do questionário; não mede a qualidade de candidaturas nem substitui a decisão de voto." />
