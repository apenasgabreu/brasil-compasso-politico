...
import { axisOrder, contextualSourcePolicy, getProgramMeta, matrixIntegrity, programs, questions, responseOptions, type Answer, type Axis } from "@/data/compassData";
